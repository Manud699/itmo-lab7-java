...
//        return executeRequest(new Request("check_id", String.valueOf(id)), "Error processing the 'check_id' command.");
//    }
//
//
//
...
//        return executeRequest(new Request("update_by_id", workerUpdated), "An error occurred while updating the worker.");
//    }
//
//
//
...
//        return executeRequest(new Request("remove_by_id", String.valueOf(id)), "An error occurred while removing the worker by ID.");
//    }
//
//
//
...
//        return executeRequest(new Request("head"), "Connection error executing the 'head' command.");
//    }
//
//
//
...
//        return executeRequest(new Request("remove_all_by_position", position.name()), "Connection error removing workers by position.");
//    }
//
//
//
...
//        return executeRequest(new Request("remove_head"), "Connection error removing the head element.");
//    }
//
//
//
...
//        return executeRequest(new Request("sum_of_salary"), "Connection error calculating the sum of salaries.");
//    }
//
//
//
...
//        return executeRequest(new Request("print_field_descending_salary"), "Connection error retrieving salaries in descending order.");
//    }
//
//
//
...
//        return executeRequest(new Request("info"), "Connection error requesting collection information.");
//    }
}